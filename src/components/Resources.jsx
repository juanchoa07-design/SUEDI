const resources = [
  ...
  { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>, title: 'Publicaciones', desc: 'Artículos científicos y revisiones producidas por socios SUEDI.' },
  ...
  { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1"/></svg>, title: 'Casos clínicos', desc: 'Banco de casos clínicos con fines educativos.' },
]
    ...
    <section className="section section-alt" id="recursos">
      <div className="container">
        ...
        <div className="resources-grid">
          {resources.map(r => (
            <a href="#" className="resource-card" key={r.title}>
              <div className="resource-icon">{r.icon}</div>
              <h4>{r.title}</h4>
              <p>{r.desc}</p>
            </a>
          ))}
          <a href="#socios" className="resource-card resource-card-cta">
